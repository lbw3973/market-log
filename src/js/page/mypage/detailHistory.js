...
const detailHistoryURL = 'https://asia-northeast3-heropy-api.cloudfunctions.net/api/products/transactions/detail';
...
<img class="product--image" src=${} alt="product image" />
            <div class="product-info">
              ...
              >
              <div>
                <span class="product--price">${detailHistory.product.price}</span>
                <span class="product--count">(${JSON.parse(localStorage.getItem('')).count}개)</span>
              </div>
            </div>
